...
class AddBookModel{
    ...
    public static function insertDataInDB($title, $author, $noPages, $description, $imageLink,$userStatus, $userId){
        ...
        $query = "SELECT count(*) from YOUR_BOOKS yb join BOOKS b on yb.book_Id = b.book_Id where yb.user_Id = ? and b.BOOK_TITLE = ? and b.BOOK_AUTHORS = ?";
        ...
        $query = "INSERT INTO YOUR_BOOKS (USER_ID, BOOK_ID) VALUES(?, ?)";
        $stmt = $database->prepare($query);
